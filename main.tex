...
\begin{table}[h]
\centering
\caption{Exposure to 287(g)  on LOG TOTAL targeted and placebo populations}
\label{tab:regtp}
\adjustbox{ width=0.7\linewidth}{
...
\begin{table}[h]
\centering
\caption{Exposure to 287(g)  on LOG TOTAL targeted and placebo populations BY GAINERS AND LOSERS}
\label{tab:regtp}
\adjustbox{ width=0.7\linewidth}{
...
\adjustbox{width=\linewidth}{\includegraphics{output/final/ingain_targetpop2_nowt_samereg.png}}
\end{minipage}
\hfill
\begin{minipage}{0.44\linewidth}
\centering

\adjustbox{width=\linewidth}{\includegraphics{output/final/inlost_targetpop2_nowt_samereg.png}}
\end{minipage}
