...
In Table \ref{tab:regpop} we evaluate the effect of having an active 287(g) agreement on the size of the target population (Columns 1-2) and placebo population (Columns 3-4) at the puma-year level (Equation \ref{eq:regpop}). In this design, I find that the size of the target population in a puma with an active 287(g) agreement declines by 0.1074 log points, or by 10.16\% in population, and by 0.1004 log points or 9.55\% when including controls at the puma-year level, both marginally significant at the 10 percent level. Meanwhile, the size of the placebo population increases at slightly smaller and statistically insignificant rates: 9.5\%, and 10.5\% when including controls. Since we are focusing on a specially narrow target population, these coefficients translate translate to modest absolute changes in population size of 40 people per puma. \citep{parrado_immigration_2012} finds also modest changes in the size of foreign born Mexican population by XX.
