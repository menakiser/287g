...
\begin{equation}
    \label{eq:reg1}
    in-migration_{imy} = \beta_{0} + \beta_{1}exposure_{m}*post_{my} +  \beta_{2}W_{y} + \beta_{3}Z_{m} + \epsilon_{my} 
\end{equation}
...
\begin{table}[h]
\centering
\caption{Balance table move}
\label{fig:timeline}
\adjustbox{ width=\linewidth}{
    \input{output/final/balancetable_move}
}
\end{table}
...
\begin{table}[h]
\centering
\caption{Out: Exposure to 287(g)  on targeted and placebo populations}
\label{tab:regtp}
\adjustbox{ width=0.7\linewidth}{
    \input{output/final/out_migration_target2}
}
\end{table}
...
\begin{table}[h]
\centering
\caption{Heterogeneity of opp}
\label{tab:regtp}
\adjustbox{ width=0.8\linewidth}{
    \input{output/final/opportunity}
}
\end{table}
...
\begin{center}
\adjustbox{ width=0.7\linewidth}{
    \includegraphics{output/prop_score.png}
}
\end{center}
\justifying
\begin{spacing}{1}
...
\begin{figure}[h]
\centering
\caption{In-migration effects of 287(g) migpuma exposure}
\label{tab:es_in_any}
...
\centering
(c) Move state
\adjustbox{width=\linewidth}{\includegraphics{output/es_in_state.png}}
\end{minipage}
...
\begin{figure}[h]
\centering
\caption{Out-migration effects of 287(g) migpuma exposure}
\label{tab:es_in_any}

\begin{minipage}{0.44\linewidth}
\centering
(a) Any move
\adjustbox{width=\linewidth}{\includegraphics{output/es_out_any.png}}
\end{minipage}
\hfill
\begin{minipage}{0.44\linewidth}
\centering
(b) Move migpuma
\adjustbox{width=\linewidth}{\includegraphics{output/es_out_migpuma.png}}
\end{minipage}
...
\centering
(c) Move state
\adjustbox{width=\linewidth}{\includegraphics{output/es_out_state.png}}
\end{minipage}
