...
Table \ref{tab:regprob} evaluates Equation \ref{eq:regpr} in a sample restricted to the target population in Columns 1 and 2. 

and restricted to the placebo population in Columns 2-4.
We find puzzling results that though distinguishable from the placebo effects point to a different direction from expected. We explore this further by focusing on total target population in later tables. 
