...
\label{tab:regtp}
\adjustbox{ width=\linewidth}{
    \input{output/final/in_migration_target2}
}
...
\begin{table}[h]
\centering
\caption{Difference-in-difference: Probability of mobility by gainer and loser status (separate regressions)}
\label{tab:regtp}
\adjustbox{ width=0.7\linewidth}{
    \input{output/final/in_gain_lost}
}
...
\begin{table}[h]
\centering
\caption{Joint difference-in-difference for probability of mobility by gainer and loser status}
\label{tab:regtp}
\adjustbox{ width=\linewidth}{
    \input{output/final/in_gain_lost_join}
}
...
\label{tab:regtp}
\adjustbox{ width=\linewidth}{
    \input{output/final/in_gain_lost_logpop}
}
...
\begin{table}[h]
\centering
\caption{Joint difference-in-difference for log total targeted and placebo populations by gainer and loser status, same regression}
\label{tab:regtp}
\adjustbox{ width=\linewidth}{
    \input{output/final/in_gain_lost_join_log}
}
...
\begin{figure}[h]
\centering
\caption{Event study of log total targeted and placebo populations by gainer and loser status, in separate regressions}
\label{tab:es_in_any}

\begin{minipage}{0.44\linewidth}
\centering
\adjustbox{width=\linewidth}{\includegraphics{output/final/ingain_total_target_nowt_log.png}}
\end{minipage}
\begin{minipage}{0.44\linewidth}
\centering
\adjustbox{width=\linewidth}{\includegraphics{output/final/inlost_total_target_nowt_log.png}}
\end{minipage}
\begin{minipage}{0.44\linewidth}
\centering
\adjustbox{width=\linewidth}{\includegraphics{output/final/ingain_placebo_nowt_log.png}}
\end{minipage}
\begin{minipage}{0.44\linewidth}
\centering
\adjustbox{width=\linewidth}{\includegraphics{output/final/inlost_placebo_nowt_log.png}}
\end{minipage}
...
\begin{figure}[h]
\centering
\caption{Event study of log total targeted and placebo populations by gainer and loser status, in the same regressions}
\label{tab:es_in_any}

\begin{minipage}{0.44\linewidth}
\centering
\adjustbox{width=\linewidth}{\includegraphics{output/final/ingain_targetpop2_nowt_samereg_log.png}}
\end{minipage}
\begin{minipage}{0.44\linewidth}
\centering
\adjustbox{width=\linewidth}{\includegraphics{output/final/inlost_targetpop2_nowt_samereg_log.png}}
\end{minipage}
\begin{minipage}{0.44\linewidth}
\centering
\adjustbox{width=\linewidth}{\includegraphics{output/final/ingain_placebo_nowt_samereg_log.png}}
\end{minipage}
\begin{minipage}{0.44\linewidth}
\centering
\adjustbox{width=\linewidth}{\includegraphics{output/final/inlost_placebo_nowt_samereg_log.png}}
\end{minipage}
