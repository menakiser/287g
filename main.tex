...
\begin{table}[h]
\centering
\caption{Difference-in-difference: Probability of mobility by gainer and loser status}
\label{tab:regtp}
...
\begin{table}[h]
\centering
\caption{Joint difference-in-difference for log total targeted and placebo populations by gainer and loser status}
\label{tab:regtp}
\adjustbox{ width=0.7\linewidth}{
...
\begin{figure}[h]
\centering
\caption{Gainers and losers in same regression}
\label{tab:es_in_any}
