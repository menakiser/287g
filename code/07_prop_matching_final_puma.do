...
logit ever_treated_puma total_pop target_sh2 foreign_sh young_sh int_yrsusa2* lowskill_sh red_state istexas isflorida ever_treated_state ///
	r_white r_black r_asian int_citizen2-int_citizen4 int_dhispan* int_educ* int_marst* in_school no_english ///
	has_child famsize nchild  [pw=total_targetpop2]
