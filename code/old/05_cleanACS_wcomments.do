...
********************************************************
**** obtain exposure variables at the PUMA level for previous year
*********************************************************
/*
*migpuma
foreach v in exp_any_puma exp_jail_puma exp_task_puma exp_warrant_puma  {
...
merge m:1 puma10 statefip year using "$oi/migpuma10_SC" , nogen keep( 1 3) 
...
rename   statefip current_statefip
rename (prev_migpuma prev_statefip) (puma10 statefip)
replace year = current_year - 1
...
//gen prev_geoid_puma = prev_statefip*100000 +  prev_migpuma if move_migpuma==1
